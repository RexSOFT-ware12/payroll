...
<aside style="background-color:green;" class="main-sidebar">
	<section class="sidebar">
		<div class="user-panel">
			...
			<div class="pull-left info">
				...
				<?php } ?>
				<a href="#"><i style="color:yellowgreen;" class="fa fa-circle text-success"></i> Online</a>
			</div>
		</div>
		<?php if ( $_SESSION['Login_Type'] != 'admin' ) { ?>
			<?php if ( $attendanceROW < 2 ) { ?>
				<form method="POST" class="employee sidebar-form" role="form" id="attendance-form">
	                <div class="input-group">
	                    <!--<input type="text" class="form-control" id="desc" name="desc" placeholder="Message" />-->
		...
		<ul class="sidebar-menu">
			...
			<?php if ( $_SESSION['Login_Type'] == 'admin' ) { ?>
				...
				<li class="<?php echo $page_name == "help" ? 'active' : ''; ?>">
					...
					<i class="fa fa-question" aria-hidden="true"></i><span>Asked Questions</span>
					</a>
				</li>
			<?php } else { ?>
				...
				<li class="<?php echo $page_name == "Help" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>Help/">
					<i class="fa fa-question" aria-hidden="true"></i><span>Help</span>
					</a>
				</li>
