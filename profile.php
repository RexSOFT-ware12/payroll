												...
												<div class="row">
													...
													<div class="col-lg-3">
														<div class="form-group">
															...
															<input type="email" class="form-control" name="email" id="email" value="<?php echo $data['email']; ?>" disabled />
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
													...
													<div class="col-lg-3">
														<div class="form-group">
															<label for="SSS">SSS Level </label>
															<input type="text" class="form-control" name="SSS" id="SSS" value="<?php echo $data['SSS']; ?>" disabled />
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
															<label for="Grade">Grade </label>
															<input type="text" class="form-control" name="Grade" id="Grade" value="<?php echo $data['Grade']; ?>" disabled />
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
															<label for="telephone">Account Status </label>
															<input type="text" class="form-control" name="telephone" id="telephone" value="<?php echo $data['telephone']; ?>" disabled />
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
															<label for="suspension">Suspension Status </label>
															<input type="text" class="form-control" name="suspension" id="suspension" value="<?php echo $data['suspension']; ?>" disabled />
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
															<label for="Position ">Position </label>
															<input type="text" class="form-control" name="Position " id="Position " value="<?php echo $data['Position ']; ?>" disabled />
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
															...
															<select class="form-control" name="identity_doc" id="identity_doc" required>
																...
																<option value="SSNIT Card" <?php echo $data['identity_doc']=='SSNIT Card'?'selected':''; ?>>SSNIT Card</option>
